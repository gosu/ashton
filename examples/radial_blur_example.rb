...
class TestWindow < Gosu::Window
  def initialize
    ...
    @blur.bright_factor = 1.5
    @blur.blur_factor = @blur_factor = 2.0
    @blur.passes = 20 # Quite a lot of work, but just proves how fast shader are!
